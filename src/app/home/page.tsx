  ...
  return (
    <div className="flex justify-center">
      <div className="w-[375px]">
        ...
        >
          ...
          <div className="flex flex-col gap-[33px]">
            <div className="flex flex-col gap-1">
              ...
              >
                <SelectTrigger
                  className={`${cognitive ? "text-[#1A1C1E]" : "text-gray-600"
            ...
            <div className="flex flex-col gap-1">
              <div
                className={`${cognitive ? "text-gray-600" : "text-gray-400"
                  } font-bold text-sm`}
              >
                Applicable measures
              </div>
              ...
              >
                <SelectTrigger
                  className={`${applicable ? "text-[#1A1C1E]" : "text-gray-600"
                    } w-full h-14 rounded-[7px] font-medium text-base border-gray-200}`}
                >
            ...
            <div className="flex flex-col gap-1">
              <div
                className={`${applicable ? "text-gray-600" : "text-gray-400"
                  } font-bold text-sm`}
              >
                Patient
              </div>
              ...
              >
                <SelectTrigger
                  className={`${patient ? "text-[#1A1C1E]" : "text-gray-600"
                    } w-full h-14 rounded-[7px] font-medium text-base border-gray-200}`}
                >
        ...
        <div className="bottom-0 fixed w-[375px] px-5 pb-5">
          <Button
            disabled={
              patient.length === 0 ||
              applicable.length === 0 ||
